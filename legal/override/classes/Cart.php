...
class Cart extends CartCore
{
	...
	public static function getTaxesAverageUsed($id_cart)
	{
		...
		*/
		...
		/* Art der MwSt-Berechnung: Entweder nach Gewichtung der Steueranteile (LEGAL_TAXMETH=0 -> parent) oder nach Hauptsteueranteil (LEGAL_TAXMETH=1) */
		if(!Configuration::get('LEGAL_TAXMETH'))
	...
	public function getPackageShippingCost($id_carrier = null, $use_tax = false, Country $default_country = null, $product_list = null, $id_zone = null)
	{
		...
		/*
		* Legal 0.0.1 | 20140320
		* Änderung der Berechnung: Versandkosten werden ab nun inkl. MwSt. angegeben. @param $use_tax default = false
		*/
		...
		// Select carrier tax
		/* Änderung der Berechnung: Versandkosten werden ab nun inkl. MwSt. angegeben. */
